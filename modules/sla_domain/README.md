...
| Name | Version |
|------|---------|
| <a name="provider_polaris"></a> [polaris](#provider\_polaris) | 1.4.0-beta.4 |
...
| <a name="input_monthly_schedule"></a> [monthly\_schedule](#input\_monthly\_schedule) | Monthly snapshot schedule configuration. | <pre>object({<br/>    day_of_month   = string<br/>    frequency      = number<br/>    retention      = number<br/>    retention_unit = string<br/>  })</pre> | `null` | no |
...
| <a name="input_weekly_schedule"></a> [weekly\_schedule](#input\_weekly\_schedule) | Weekly snapshot schedule configuration. | <pre>object({<br/>    day_of_week    = optional(string, "MONDAY")<br/>    frequency      = number<br/>    retention      = number<br/>    retention_unit = string<br/>  })</pre> | `null` | no |
