...
# Point the RSC provider to the Polaris service account to use.
provider "polaris" {
...
# Add the Azure service principal to RSC. When the permission hash changes a
# diff will be generated by Terraform.
